		...
		gpointer data )
{
	 ...
	 *	the "destroy" signal. Returning TRUE means you don't want the window
	 *	to be destroyed.
	 *
	 *	This is useful for popping uo 'are you sure you want to quit?'
	 */
...
{
	/* GtkWidget is the storage type for widget */
	GtkWidget *window;
	GtkWidget *button;

	/*
	 *	This is called in all GTK application. Arguments are parsed from The
